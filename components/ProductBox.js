...
export default function ProductBox({ _id, title, description, images, price, category, properties, product, slug }) {
  ...
  // التحقق من عدد الألوان وتعديل العرض إذا كان أكثر من 5
  ...
  return (
    ...
    >
      {!isImageLoaded ? (
        // اللودر مع اللمعة البطيئة للصورة
          ...
          <Link href={`/product/${slug}`}>
            <div className="relative overflow-hidden group">
              <img
                src={images[0]}
                alt="product"
                className="w-[150px] h-[190px] sm:w-[150px] sm:h-[190px] md:w-[180px] md:h-[260px] lg:w-[180px] lg:h-[260px] xl:w-[200px] xl:h-[280px] rounded-md m-1.5 transition-transform duration-300 group-hover:scale-105 bg-white object-cover cursor-pointer"
          ...
          <div className="pl-2 pb-1 text-left flex-grow flex flex-col">
            ...
            <div className="text-sm flex flex-wrap -mb-2.5 gap-0.5 flex-grow relative">
              ...
              {additionalColorsCount > 0 && (
                <span className="text-sm text-gray-800  absolute -top-1 right-12 sm:right-12 md:right-20 xl:right-24 ">
