...
const ContactInfo = [
  ...
  { label: "Address", value: "1234 Street Name, City, Country" },
];
...
export default function Footer() {
  return (
    <footer className="bg-darkes text-center text-white py-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <FooterSection title="Customers" items={CustomerLinks} />
          <FooterSection title="Contact Us" items={ContactInfo} />
        </div>
        ...
        <div className="">
          <div className="card">
            ...
            {SocialLinks.map((link, index) => (
              <Link key={index} href={link.href} className="social-link" target="_blank" rel="noopener noreferrer">
                {link.icon}
              </Link>
            ))}
          </div>
