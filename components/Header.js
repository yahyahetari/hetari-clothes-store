  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white flex items-center justify-between text-lg font-medium text-black p-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <Link href="/cart" className="flex items-center p-2 hover:text-gray-600 relative">
      ...
      {menuOpen && (
        <div ref={menuRef} className="absolute top-16 left-0 w-full p-4 bg-white flex flex-col items-center gap-4 md:hidden z-50">
          {navLinks.map((link) => (
